...
const ROWS: Row[] = [
  ...
  ['Osaka', 'Japan', 'Asia/Tokyo', 34.69, ['KIX']],
  ['Kyoto', 'Japan', 'Asia/Tokyo', 35.01, ['Kyōto']],
  ['Nagoya', 'Japan', 'Asia/Tokyo', 35.18, ['NGO']],
  ['Sapporo', 'Japan', 'Asia/Tokyo', 43.06, ['CTS']],
  ['Fukuoka', 'Japan', 'Asia/Tokyo', 33.59, ['FUK']],
  ['Seoul', 'South Korea', 'Asia/Seoul', 37.57, ['KST', 'ICN']],
  ['Busan', 'South Korea', 'Asia/Seoul', 35.18, ['PUS']],
  ['Shanghai', 'China', 'Asia/Shanghai', 31.23, ['PVG']],
  ['Beijing', 'China', 'Asia/Shanghai', 39.9, ['PEK']],
  ['Shenzhen', 'China', 'Asia/Shanghai', 22.54, ['SZX']],
  ['Chengdu', 'China', 'Asia/Shanghai', 30.57, ['CTU', 'Chengtu']],
  ['Guangzhou', 'China', 'Asia/Shanghai', 23.13, ['CAN', 'Canton']],
  ['Hangzhou', 'China', 'Asia/Shanghai', 30.27, ['HGH']],
  ['Chongqing', 'China', 'Asia/Shanghai', 29.56, ['CKG']],
  ['Wuhan', 'China', 'Asia/Shanghai', 30.59, ['WUH']],
  ["Xi'an", 'China', 'Asia/Shanghai', 34.34, ['Xian', 'XIY']],
  ['Nanjing', 'China', 'Asia/Shanghai', 32.06, ['NKG']],
  ['Qingdao', 'China', 'Asia/Shanghai', 36.07, ['TAO']],
